...
public class InquiryBoardAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		System.out.println("InquiryBoardAction 확인");
		...
		CustomerDAO inquirycount = new CustomerDAO();
		count = inquirycount.inquiryBoardCount(category, searchid);
		...
		forward.setPath("./customer/inquiryBoard.jsp");
		return forward;
	}
